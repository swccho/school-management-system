...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['module' => 'notices', 'name' => 'Delete Notices', 'slug' => 'delete-notices'],
            ['module' => 'news', 'name' => 'View News Posts', 'slug' => 'view-news-posts'],
            ['module' => 'news', 'name' => 'Create News Posts', 'slug' => 'create-news-posts'],
            ['module' => 'news', 'name' => 'Edit News Posts', 'slug' => 'edit-news-posts'],
            ['module' => 'news', 'name' => 'Delete News Posts', 'slug' => 'delete-news-posts'],
            ['module' => 'news', 'name' => 'Publish News Posts', 'slug' => 'publish-news-posts'],
            ...
            ['module' => 'events', 'name' => 'Delete Events', 'slug' => 'delete-events'],
            ['module' => 'events', 'name' => 'Publish Events', 'slug' => 'publish-events'],
            ['module' => 'gallery', 'name' => 'View Gallery', 'slug' => 'view-gallery'],
            ['module' => 'gallery', 'name' => 'Manage Gallery', 'slug' => 'manage-gallery'],
            ['module' => 'downloads', 'name' => 'View Downloads', 'slug' => 'view-downloads'],
            ['module' => 'downloads', 'name' => 'Create Downloads', 'slug' => 'create-downloads'],
            ['module' => 'downloads', 'name' => 'Edit Downloads', 'slug' => 'edit-downloads'],
            ['module' => 'downloads', 'name' => 'Delete Downloads', 'slug' => 'delete-downloads'],
            ['module' => 'downloads', 'name' => 'Publish Downloads', 'slug' => 'publish-downloads'],
            ['module' => 'pages', 'name' => 'View Pages', 'slug' => 'view-pages'],
            ['module' => 'pages', 'name' => 'Create Pages', 'slug' => 'create-pages'],
            ['module' => 'pages', 'name' => 'Edit Pages', 'slug' => 'edit-pages'],
            ['module' => 'pages', 'name' => 'Delete Pages', 'slug' => 'delete-pages'],
            ['module' => 'pages', 'name' => 'Publish Pages', 'slug' => 'publish-pages'],
            ['module' => 'homepage', 'name' => 'Manage Banners', 'slug' => 'manage-banners'],
            ['module' => 'homepage', 'name' => 'Manage Homepage Sections', 'slug' => 'manage-homepage-sections'],
            ...
            ['module' => 'activity-logs', 'name' => 'View Activity Logs', 'slug' => 'view-activity-logs'],
            ['module' => 'system-monitoring', 'name' => 'View System Monitoring', 'slug' => 'view-system-monitoring'],
            ['module' => 'maintenance', 'name' => 'Manage Maintenance', 'slug' => 'manage-maintenance'],
            ['module' => 'backups', 'name' => 'View Backups', 'slug' => 'view-backups'],
            ['module' => 'backups', 'name' => 'Generate Backups', 'slug' => 'generate-backups'],
            ['module' => 'admin-guide', 'name' => 'View Admin Guide', 'slug' => 'view-admin-guide'],
            ['module' => 'admin-guide', 'name' => 'Manage Admin Guide Categories', 'slug' => 'manage-admin-guide-categories'],
            ['module' => 'admin-guide', 'name' => 'Manage Admin Guides', 'slug' => 'manage-admin-guides'],
        ];
